...
if (isset($_POST['form1'])) {
    ...
    } elseif (!preg_match("/^[a-zA-ZáéíóúÁÉÍÓÚñÑ\s]+$/", $_POST['cust_name'])) {
        $valid = 0;
        $error_message .= "Nombre no válido. Solo letras y espacios permitidos.<br>";
    }
    ...
    if (empty($_POST['cust_phone'])) {
        ...
        $valid = 0;
        $error_message .= "Número de teléfono no válido. Solo números permitidos.<br>";
    }
    ...
    } elseif (!preg_match("/^[a-zA-ZáéíóúÁÉÍÓÚñÑ\s]+$/", $_POST['cust_city'])) {
        $valid = 0;
        $error_message .= "Ciudad no válida. Solo letras y espacios permitidos.<br>";
    }
    ...
    } elseif (!preg_match("/^[a-zA-ZáéíóúÁÉÍÓÚñÑ\s]+$/", $_POST['cust_state'])) {
        $valid = 0;
        $error_message .= "Estado no válido. Solo letras y espacios permitidos.<br>";
    }
    ...
    if (empty($_POST['cust_zip'])) {
        ...
        $valid = 0;
        $error_message .= "Código postal no válido. Solo números permitidos.<br>";
    }
