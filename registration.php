...
if (isset($_POST['form1'])) {
    ...
    if(empty($_POST['cust_name'])) {
        ...
        if (!preg_match('/^[a-zA-ZàáâãäåçèéêëìíîïðòóôõöùúûüýÿÀÁÂÃÄÅÇÈÉÊËÌÍÎÏÐÒÓÔÕÖÙÚÛÜÝŸ\s]+$/', $_POST['cust_name'])) {
            $valid = 0;
            $error_message .= "El nombre solo debe contener letras y espacios.<br>";
        }
    }
    ...
    if(empty($_POST['cust_phone'])) {
        ...
        if (!preg_match('/^[0-9]+$/', $_POST['cust_phone'])) {
            $valid = 0;
            $error_message .= "El número de teléfono solo debe contener números.<br>";
        }

        if ($_POST['cust_phone'] < 0) {
            $valid = 0;
            $error_message .= "El número de teléfono no debe ser negativo.<br>";
        }
    }
    ...
    if(empty($_POST['cust_city'])) {
        ...
        if (!preg_match('/^[a-zA-ZàáâãäåçèéêëìíîïðòóôõöùúûüýÿÀÁÂÃÄÅÇÈÉÊËÌÍÎÏÐÒÓÔÕÖÙÚÛÜÝŸ\s]+$/', $_POST['cust_city'])) {
            $valid = 0;
            $error_message .= "La ciudad solo debe contener letras y espacios.<br>";
        }
    ...
    if(empty($_POST['cust_state'])) {
        ...
        if (!preg_match('/^[a-zA-ZàáâãäåçèéêëìíîïðòóôõöùúûüýÿÀÁÂÃÄÅÇÈÉÊËÌÍÎÏÐÒÓÔÕÖÙÚÛÜÝŸ\s]+$/', $_POST['cust_state'])) {
            $valid = 0;
            $error_message .= "El estado solo debe contener letras y espacios.<br>";
        }
    }
    ...
    if(empty($_POST['cust_zip'])) {
        ...
        if (!preg_match('/^[0-9]+$/', $_POST['cust_zip'])) {
            $valid = 0;
            $error_message .= "El código postal solo debe contener números.<br>";
        }

        if ($_POST['cust_zip'] < 0) {
            $valid = 0;
            $error_message .= "El código postal no debe ser negativo.<br>";
        }
    }
    ...
    if( empty($_POST['cust_password']) || empty($_POST['cust_re_password']) ) {
        ...
        if (strlen($_POST['cust_password']) < 8) {
            $valid = 0;
            $error_message .= "La contraseña debe tener al menos 8 caracteres.<br>";
        }

        if (!preg_match('/[A-Z]/', $_POST['cust_password'])) {
            $valid = 0;
            $error_message .= "La contraseña debe contener al menos una mayúscula.<br>";
        }

        if (!preg_match('/[a-z]/', $_POST['cust_password'])) {
            $valid = 0;
            $error_message .= "La contraseña debe contener al menos una minúscula.<br>";
        }

        if (!preg_match('/[0-9]/', $_POST['cust_password'])) {
            $valid = 0;
            $error_message .= "La contraseña debe contener al menos un número.<br>";
        }

        if (!preg_match('/[^A-Za-z0-9]/', $_POST['cust_password'])) {
            $valid = 0;
            $error_message .= "La contraseña debe contener al menos un carácter especial.<br>";
        }
