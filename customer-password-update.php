...
if (isset($_POST['form1'])) {
    ...
    if( !empty($_POST['cust_password']) && !empty($_POST['cust_re_password']) ) {
        if($_POST['cust_password'] != $_POST['cust_re_password']) {
            ...
            if(!isValidPassword($_POST['cust_password'])) {
                $valid = 0;
                $error_message .= "La contraseña debe tener al menos 8 caracteres, incluir al menos un carácter especial, un número, una mayúscula y una minúscula.<br>";
            }
        }
    }
