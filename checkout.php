		                ...
		                <?php if($checkout_access == 0): ?>
		                	<div class="col-md-12">
				                <div style="color:red;font-size:22px;margin-bottom:50px;">
			                        Debe completar toda la información de facturación y envío desde su panel de control para poder realizar el pago del pedido. Por favor complete la información yendo a <a href="customer-billing-shipping-update.php" style="color:red;text-decoration:underline;">este link</a>.
			                    </div>
	                    	</div>
	                	<?php else: ?>
		                	<div class="col-md-4">
