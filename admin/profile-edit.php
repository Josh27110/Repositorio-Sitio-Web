...
if(isset($_POST['form3'])) {
    ...
    if( empty($_POST['password']) || empty($_POST['re_password']) ) {
        ...
        if (!preg_match('/[A-Z]/', $password)) {
            $valid = 0;
            $error_message .= "La contraseña debe contener al menos una letra mayúscula<br>";
        }
        if (!preg_match('/[a-z]/', $password)) {
            $valid = 0;
            $error_message .= "La contraseña debe contener al menos una letra minúscula<br>";
        }
    ...
    if($valid == 1) {
        ...
        $success_message = 'La contraseña del usuario se ha actualizado correctamente.';
    }
}
